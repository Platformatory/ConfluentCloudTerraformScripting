...
module "sa_role_bindings" {
    ...
    sa_name = data.confluent_service_account.app-manager-sa.display_name
    sa_id = data.confluent_service_account.app-manager-sa.id
    sa_api_version = data.confluent_service_account.app-manager-sa.api_version
    sa_kind = data.confluent_service_account.app-manager-sa.kind
